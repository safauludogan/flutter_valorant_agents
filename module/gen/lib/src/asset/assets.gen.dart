...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_english.png
  AssetGenImage get imgEnglish =>
      const AssetGenImage('assets/images/img_english.png');

  /// File path: assets/images/img_turkish.png
  AssetGenImage get imgTurkish =>
      const AssetGenImage('assets/images/img_turkish.png');

  /// List of all assets
  List<AssetGenImage> get values => [imgEnglish, imgTurkish];
}
