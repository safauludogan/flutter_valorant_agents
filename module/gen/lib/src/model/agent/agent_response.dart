...
final class AgentResponse extends IDioNexusNetworkModel<AgentResponse>
  ...
  AgentResponse({this.status, this.agentRoles});
  ...
  @override
  List<Object?> get props => [status, agentRoles];

  AgentResponse copyWith({int? status, List<AgentRole>? agentRoles}) {
    return AgentResponse(
      status: status ?? this.status,
      agentRoles: agentRoles ?? this.agentRoles,
    );
  }

  @override
  String toString() {
    return 'AgentResponse(status: $status, AgentRoles: $agentRoles)';
  }
}
